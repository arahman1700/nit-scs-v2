...
// ---------------------------------------------------------------------------
// Generates the OpenAPI 3.0.0 spec for the NIT Supply Chain V2 API.
// Combines inline path definitions with JSDoc @openapi annotations found in
// route files and the document-factory utility.
//
// Interactive docs:  /api-docs
// Raw JSON spec:     /api-docs.json
// ---------------------------------------------------------------------------
...
const options: swaggerJsdoc.Options = {
  definition: {
    ...
    info: {
      ...
      version: '2.0.0',
      description:
        'Enterprise supply chain management API — 19 domains, 250+ endpoints. ' +
        'Covers the full lifecycle of supply-chain operations including material ' +
        'receiving (GRN/MRRV), material issuance (MI/MIRV), material returns ' +
        '(MRN/MRV), quality control inspections (QCI/RFIM), discrepancy reports ' +
        '(DR/OSD), inventory tracking, warehouse management, job orders, gate ' +
        'passes, stock transfers, material requisitions (MR/MRF), shipments, ' +
        'workflow-driven approvals, barcode generation & lookup, bulk operations, ' +
        'Excel import/export, audit logging, dashboards, and reports. ' +
    ...
    tags: [
      ...
      { name: 'Document Factory', description: 'Generic CRUD operations generated by the document-factory' },
      { name: 'MRRV', description: 'Material Receiving Report Voucher (GRN) — inbound material receipts' },
      { name: 'MIRV', description: 'Material Issue Report Voucher (MI) — outbound material issuance' },
      { name: 'MRV', description: 'Material Return Voucher (MRN) — returning issued materials' },
      { name: 'RFIM', description: 'Request for Inspection of Materials (QCI)' },
      { name: 'OSD', description: 'Over / Short / Damage reports (DR)' },
      ...
      { name: 'Stock Transfers', description: 'Inter-warehouse stock transfers (WT)' },
      { name: 'MRF', description: 'Material Requisition Forms (MR)' },
  ...
  // Scan route files and the document-factory for @openapi JSDoc annotations
