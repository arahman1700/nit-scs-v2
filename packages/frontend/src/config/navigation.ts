  ...
  [UserRole.ADMIN]: [
    ...
    // ── Section 2: Logistics & Fleet ──
    {
      ...
      children: [
        ...
        { label: '---', type: 'divider' },
        { label: 'IMSF - Material Shifting', path: '/admin/logistics?tab=imsf' },
        { label: 'WT - Warehouse Transfer', path: '/admin/logistics?tab=wt' },
    ...
    // ── Section 3: Asset Lifecycle ──
    {
      ...
      children: [
        ...
        { label: 'Scrap Management', path: '/admin/assets?tab=scrap' },
